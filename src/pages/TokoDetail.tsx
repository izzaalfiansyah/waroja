        ...
        <div class="flex md:flex-row flex-col">
          <div class="md:w-1/2 md:pr-14 md:mb-0 mb-20">
            <Show
              ...
              fallback={
                <>
                  <div class="bg-gray-100 dark:bg-gray-700 rounded-lg lg:h-400px h-300px mb-4 animate animate-pulse" />
                  <div class="flex flex-row flex-wrap">
                    <For each={Array(3)}>
                      {(img) => (
                        <div class="rounded bg-gray-100 dark:bg-gray-700 lg:h-80px h-50px lg:w-80px w-50px mr-2 mb-2 object-cover animate animate-pulse" />
                      )}
                    </For>
                  </div>
                </>
            ...
            >
              <img
                class="bg-gray-100 dark:bg-gray-700 rounded-lg lg:h-400px h-300px mb-4 object-cover w-full"
                src={imgActive()}
              />
              <div class="flex flex-row flex-wrap">
                <For each={item()?.img}>
                  {(img) => (
                    <img
                      class="rounded bg-gray-100 dark:bg-gray-700 lg:h-80px h-50px lg:w-80px w-50px mr-2 mb-2 object-cover cursor-pointer transition"
                      classList={{
                        "ring-2 ring-primary shadow-md shadow-primary":
                          img == imgActive(),
                      }}
                      src={img}
                      onClick={(e) => {
          ...
          <div class="md:w-1/2 md:text-left text-center">
            <Show
              ...
              fallback={
                <>
                  <div class="h-12 rounded-full bg-gray-100 dark:bg-gray-700 animate animate-pulse"></div>
                  <div class="mt-5 h-4 rounded-full bg-gray-100 dark:bg-gray-700 animate animate-pulse"></div>
                  <div class="mt-2.5 w-1/2 h-4 rounded-full bg-gray-100 dark:bg-gray-700 animate animate-pulse"></div>
                  <div class="mt-10 h-4 rounded-full bg-gray-100 dark:bg-gray-700 animate animate-pulse"></div>
                  <div class="mt-2.5 h-4 rounded-full bg-gray-100 dark:bg-gray-700 animate animate-pulse"></div>
                  <div class="mt-2.5 h-4 rounded-full bg-gray-100 dark:bg-gray-700 animate animate-pulse"></div>
                  <div class="mt-2.5 h-4 rounded-full bg-gray-100 dark:bg-gray-700 animate animate-pulse"></div>
                  <div class="mt-2.5 w-1/2 h-4 rounded-full bg-gray-100 dark:bg-gray-700 animate animate-pulse"></div>
                </>
            ...
            >
              ...
              <div class="mt-10 grid grid-cols-3 gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  class="p-5 py-3 mb-3 rounded shadow flex space-x-4 items-center text-purple-400 border border-purple-400 transition hover:(bg-purple-400 text-white)"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
